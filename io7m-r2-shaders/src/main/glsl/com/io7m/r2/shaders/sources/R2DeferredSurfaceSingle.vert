...
main (void)
{
  ...
  vec4 position_eye =
    (R2_deferred_surface_matrices_instance.transform_modelview * position_hom);
  vec4 position_clip =
    ((R2_deferred_surface_matrices_view.transform_projection * R2_deferred_surface_matrices_instance.transform_modelview) * position_hom);
  ...
  vec2 uv        = (R2_deferred_surface_matrices_instance.transform_uv * vec3 (R2_vertex_uv, 1.0)).xy;
