#ifndef R2_LIGHT_SPHERICAL_DIFFUSE_ONLY_H
#define R2_LIGHT_SPHERICAL_DIFFUSE_ONLY_H

/// \file R2LightSphericalDiffuseOnly.h
...
#endif // R2_LIGHT_SPHERICAL_DIFFUSE_ONLY_H
