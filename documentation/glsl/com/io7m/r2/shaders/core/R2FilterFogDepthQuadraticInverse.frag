/// \file R2FilterFogDepthQuadraticInverse.frag
/// \brief Inverse quadratic fog filter based on depth
...
main (void)
{
  ...
  out_rgba = vec4(R2_fogQuadraticInverse(R2_fog, surface.xyz, eye_z_positive), surface.w);
}
